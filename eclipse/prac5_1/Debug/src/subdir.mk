...
src/%.o: ../src/%.c
	...
	sparc-rtems-gcc -I/home/cesar/workspace/prac5_1/include -I/opt/rtems-4.6/sparc-rtems/leon3/lib/include -O0 -g3 -Wall -msoft-float -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
