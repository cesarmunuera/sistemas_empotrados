		...
		switch(edroomCurrentTrans.localId)
		{
			...
			case (CheckObstacle):
				...
				if( GObsDetected() )
				{
					...
					//Branch taken is CheckObstacle_ObsDetected
					edroomCurrentTrans.localId =
						CheckObstacle_ObsDetected;
				...
				else
				{
					...
					//Branch taken is CheckObstacle_NoObstacle
					edroomCurrentTrans.localId =
						CheckObstacle_NoObstacle;
		...
		switch(Msg->signal)
		{
			...
			case (EDROOMSignalTimeout): 
				 ...
				 if (*Msg->GetPInterface() == Timer)
				{
					...
					//Next transition is  CheckObstacle
					edroomCurrentTrans.localId = CheckObstacle;
					edroomCurrentTrans.distanceToContext = 0 ;
					edroomValidMsg=true;
				 }
