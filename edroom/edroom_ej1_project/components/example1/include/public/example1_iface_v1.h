 ...
 *
 */
class Example1: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMExample1Signal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMExample1Signal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy };

	/**
	 * \class Example1::CEDROOMMemory
	...
	//! Constructor
	Example1(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
